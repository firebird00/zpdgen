...
#    plt.contourf(za['real'],za['imag'],eps['real'],500)
    plt.pcolormesh(za['real'],za['imag'],eps['real'],shading='gouraud',rasterized=True)
#    ax=plt.gca()
#    ax.set_rasterization_zorder(-10)
    plt.clim(-10,10)
    cs=plt.contour(za['real'],za['imag'],eps['real'],cnts,colors='k',linewidths=wdts*0.5)
...
plt.figure(2)
s=plt.contourf(za['real'],za['imag'],eps['real']*(eps['real']<14)*(eps['real']>-14),100)
plt.clim(-10,10)
plt.close()
plt.figure(1)
...
#plt.show()
#plt.savefig("patates.pdf", dpi=150)
