...
C      VOL. 16, NO. 1, PP. 47.
      SUBROUTINE WOFZH (XI, YI, U, V, FLAG)
C
...
c      IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      DOUBLE PRECISION XI,YI,U,V,FACTOR,RMAXREAL,RMAXEXP,RMAXGONI,
     *     X,Y,XABS,YABS,QRHO,XQUAD,YQUAD,XSUM,YSUM,XAUX,YAUX,H,
     *     U1,V1,DAUX,U2,V2,H2,TX,TY,SX,SY,RX,RY,QLAMBDA,C,XABSQ
      LOGICAL A, B, FLAG
      INTEGER N,J,KAPN,NU,NP1,I
...
C         AGAINST OVERFLOW
C
C          IF ((YQUAD.GT.RMAXGONI).OR.
C     *        (XQUAD.GT.RMAXEXP)) GOTO 100
C*
C          W1 =  2*DEXP(XQUAD)
C          U2  =  W1*DCOS(YQUAD)
C          V2  = -W1*DSIN(YQUAD)
