C      INMZPD
      subroutine inmzpd (xi, yi, zb, bi, n, m, mweid, u, v, flag)
...
C
     ...
     *     work(4000),resr,resi,zbb,bbi,limsingsm,limsinglg
      ...
      INTEGER n,m,np1,nu,j,l,iwork(1000),ier,neval,mw,mweid
      LOGICAL A, B, FLAG
...
C     inm
      subroutine Inmweid(za,zb,b,n,m,mw,numza,res)
...
Cf2py double complex dimension(numza) :: res
      ...
      do 10 k=1,numza
         ...
         call inmzpd(xi,yi,zb,b,n,m,mw,u,v,flag)
         if(flag) goto 110
         res(k)=dcmplx(u,v)
 10   continue
      return
